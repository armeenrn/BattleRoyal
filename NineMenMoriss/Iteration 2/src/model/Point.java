...
public class Point {
	...
	/**
	 * getOccupiedPlayer returns the number of the player occupying the stone (if
	 * any)
	 * 
	...
	/**
	 * setOccupiedPlayer sets the player occupying the point when they place their
	 * stone onto it
	 * 
	 * @param occupiedPlayer, the integer number of the player who's stone is to be
	 *                        placed
	 */
	...
	/**
	 * to String returns a string representation of the point based on its x and y
	 * coordinates
	 */
