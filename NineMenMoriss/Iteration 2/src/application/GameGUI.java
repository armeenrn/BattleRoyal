...
public class GameGUI extends GameConfig {
	...
	/*
	  button specifically set for animation
	 	idea of FadeTransition retrieved from
	 	https://docs.oracle.com/javase/9/docs/api/javafx/animation/FadeTransition.html
	 */
	...
	/**
	 * Disable all points and stones clickable, for work to be done. Only rules and
	 * quit button can be clicked
	 */
	...
	/**
	 * Sets animation for available points to move to; used for placing and jumping
	 * stage
	 */
